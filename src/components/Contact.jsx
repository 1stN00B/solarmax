                    ...
                    <div className="footer-main-content">
                        ...
                        <div className="footer-branding animate-on-scroll slide-in-left delay-1">
                            ...
                            <ul className="social-wrapper">
                                <li className="social-icon facebook animate-on-scroll slide-in delay-2"> 
                                    <span className="tooltip">Facebook</span>
                                    <svg viewBox="0 0 320 512" height="1.2em" fill="currentColor">
                                        <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
                                    </svg>
                                </li>
                                <li className="social-icon twitter animate-on-scroll slide-in delay-3"> 
                                ...
                                <li className="social-icon instagram animate-on-scroll slide-in delay-4">
