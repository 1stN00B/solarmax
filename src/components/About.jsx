...
export default function About() {
  ...
  useEffect(() => {
    // Initialize carousel when component mounts or route changes
    const initializeCarousel = () => {
      if (window.bootstrap) {
        const carouselElement = document.getElementById('aboutUsCarousel');
  ...
  }, [location.key]); // Reinitialize when route changes
  return (
      ...
      <div className='container-aboutus'>
        <div id="aboutUsCarousel" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-indicators">
            <button type="button" data-bs-target="#aboutUsCarousel" data-bs-slide-to="0" className="active"></button>
            ...
            <div className="carousel-item active">
              <div className="row g-0 align-items-center">
                <div className="col-md-6 p-5">
                  <h1 className="heading-aboutus1">About Us</h1>
                  <div className="slide-text">
                    <h3 className="slide-heading">Who We Are: Your Local Solar Experts</h3>
                    <p className="slide-description">
                      We're a passionate, forward-thinking team dedicated to making solar energy accessible for Pakistan.
                      Though new to the scene, our expertise in solar technology and customer-first approach sets us apart.
                      We're here to guide you every step of the way—no jargon, no pressure, just honest solutions.
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="img-box">
                    <img src="/images/panels.svg" className="img-fluid" alt="Solar panels" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="carousel-item">
              <div className="row g-0 align-items-center">
                <div className="col-md-6 p-5">
                  <h1 className="heading-aboutus1">About Us</h1>
                  <div className="slide-text">
                    <h3 className="slide-heading">Powering Homes with Sustainable Energy</h3>
                    <p className="slide-description">
                      Our mission? To help homeowners like you save money and protect the planet with clean energy.
                      We design modern, efficient solar systems that fit your needs, backed by transparent pricing and a streamlined process.
                      Together, let's turn sunlight into savings and sustainability.
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="img-box">
                    <img src="/images/panels2.svg" className="img-fluid" alt="Installation team" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="carousel-item">
              <div className="row g-0 align-items-center">
                <div className="col-md-6 p-5">
                  <h1 className="heading-aboutus1">About Us</h1>
                  <div className="slide-text">
                    <h3 className="slide-heading">Committed to a Brighter, Sustainable Future</h3>
                    <p className="slide-description">
                      As a new company, we're driven by innovation and a commitment to ethical, eco-friendly practices.
                      We use the latest solar technology and prioritize quality to ensure your system delivers for decades.
                      Join us in shaping a cleaner tomorrow—starting right here in Lahore.
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="img-box">
                    <img src="/images/panels3.svg" className="img-fluid" alt="Solar technology" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <button className="carousel-control-prev" type="button" data-bs-target="#aboutUsCarousel" data-bs-slide="prev">
            <span className="carousel-control-prev-icon" aria-hidden="true" style={{ background: "transparent", border: "none",padding: 0 }}></span>
            <span className="visually-hidden">Previous</span>
          </button>
          <button className="carousel-control-next" type="button" data-bs-target="#aboutUsCarousel" data-bs-slide="next">
            <span className="carousel-control-next-icon" aria-hidden="true" style={{ background: "transparent", border: "none",padding: 0 }}></span>
